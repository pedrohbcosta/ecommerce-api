...
RSpec.describe "Admin V1 System Requirements as :admin", type: :request do
  ...
  context "POST /system_requirements" do
    ...
    context "with valid params" do
      let(:system_requirement_params) { { system_requirement: attributes_for(
                                                :system_requirement) }.to_json }
    ...
    context "with invalid params" do
      let(:system_requirement_invalid_params) do
        { system_requirement: attributes_for(:system_requirement, 
                                              name: nil) }.to_json
      end
  ...
  context "PATCH /system_requirements/:id" do
    ...
    context "with valid params" do
      ...
      it "updates the system requirement" do
    ...
    context "with invalid params" do
      ...
      it "does not update the system requirement" do
